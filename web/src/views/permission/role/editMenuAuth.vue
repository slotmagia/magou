...
<script lang="ts" setup>
  ...
  import { GetPermissions, getRoleList, UpdatePermissions, getRoleMenus, updateRoleMenus } from '@/api/system/role';
  ...
  async function confirmForm(e) {
    ...
    try {
      // 优先使用新的多租户API
      await updateRoleMenus(formValue.value.id, checkedKeys.value ?? []);
